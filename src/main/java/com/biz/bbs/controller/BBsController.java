...
public class BBsController {
	...
	public String write_up(@ModelAttribute("bbsReqDto") BBsReqDto bbsReqDto, SessionStatus sStatus, 
			Model model) {
	...
	public String reply(
			@PathVariable long bbs_seq, @ModelAttribute("bbsReqDto") BBsReqDto bbsReqDto, Model model) {
